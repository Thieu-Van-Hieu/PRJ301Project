...
<html lang="en">
    ...
    <body>
        ...
        <jsp:include page="noiceSuccess.jsp"/>
            ...
            <div class="login-form">
                <form action="${pageContext.request.contextPath}/LoginServlet" method="post" id="myForm">
                    ...
                    <div class="inputGroup inputGroup1">
                        ...
                        <input type="text" id="loginEmail" maxlength="254" name="username" placeholder="Tên đăng nhập" />
                    </div>
                    <div class="inputGroup inputGroup2">
                        ...
                        <label id="showPasswordToggle" for="showPasswordCheck" style="color: #B3BBBD;">Hiển thị
